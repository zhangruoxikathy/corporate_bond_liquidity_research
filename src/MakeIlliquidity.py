...
# * Load daily data                        */
# * ************************************** */
df = pd.read_csv('Prices_BBW_TRACE_Enhanced_Dick_Nielsen.csv.gzip', compression='gzip')
dfv = pd.read_csv('Volumes_BBW_TRACE_Enhanced_Dick_Nielsen.csv.gzip', compression="gzip")
...
dfExport = Illiq.merge(AHx, how="inner", left_on=['cusip', 'date'], right_on=['cusip', 'date'])
dfExport.to_hdf('bond_illiq_monthly_dick_nielsen.h5', key='daily', mode='w')
# =============================================================================
